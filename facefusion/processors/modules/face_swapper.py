...
def register_args(program : ArgumentParser) -> None:
	...
	if group_processors:
		group_processors.add_argument('--face-swapper-model', help = wording.get('help.face_swapper_model'), default = config.get_str_value('processors', 'face_swapper_model', 'inswapper_128'), choices = processors_choices.face_swapper_models)
